    ...
    <li class="list-group-item">
      <div class="row">
       ...
       <div class="col-6 col-lg-9 mt-3" style="float:right"> 
          <?php echo  anchor('turmas/editar/'.$row->id_turma, '<i class="fas fa-edit"></i>', array('title'=>'Editar Turma', 'class'=>'btn btn-primary', 'style'=>'border-radius:50%;  float:right; margin-left:10px')); ?> 
