<div class="row mt-5">
  ...
  <div class="col-md-9">
    ...
    <div id="listarJogos">
      ...
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos.png'); ?>" " alt="">
      <h5>2° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos_listar.png?06062019'); ?>" " alt="">
    </div>
    <div id="editarJogo">
      <h4>Editar Jogo</h4>
      <hr>
      ...
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos.png'); ?>" " alt="">
      <h5>2° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos_listar.png?04062019'); ?>" " alt="">
      <h5>3° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogo_editar.png'); ?>" " alt="">
    </div>
    <div id="sumulaJogo">
      ...
      <h5>3° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/sumulaJogo.png'); ?>" " alt="">
    </div>
  </div>
</div>
