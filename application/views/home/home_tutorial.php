<div class="row mt-5">
  <div class="col-md-3" style="background-color: #e3d2ff; padding:20px">
    ...
    <ul>
      ...
      <li class=""><a class="" href="#" id="equipesTurma">Visualizar Equipes da Turma</a></li>
    </ul>
    <h4>EQUIPES</h4>
    <ul>
    ...
    <h4>JUIZ</h4>
    <ul>
      <li class=""><a class="" href="#" id="cadastrarJuiz">Cadastrar Juiz</a></li>
  ...
  <div class="col-md-9">
    ...
    <div id="equipesTurma">
      <h4>Visualizar Equipes da Turma</h4>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/turmas_equipes.png'); ?>" alt="">
    </div>

    <div id="cadastrarEquipe">
      <h4>Cadastrar Equipe</h4>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/equipes_cadastrar.png'); ?>" alt="">
    </div>
 
    <div id="editarEquipe">
      <h4>Editar Equipe</h4>
      <hr>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/equipes_editar.png'); ?>"  alt="">
    </div>
    <div id="adicionarIntegrantes">
      <h4>Adicionar Integrantes</h4>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/integrantes_adicionar.png?2019'); ?>" alt="">
    </div>
    ...
    <div id="cadastrarJogo">
      ...
      <hr>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos_cadastrar.png'); ?>" " alt="">
    </div>
    <div id="editarJogo">
      <h4>Editar Jogo</h4>
      <hr>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos_editar.png?02072019'); ?>" " alt="">
    </div>
    <div id="sumulaJogo">
      <h4>Súmula do Jogo</h4>
      <hr>
      <h5>1° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos.png'); ?>" " alt="">
      <h5>2° Passo</h5>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/jogos_sumula.png'); ?>" " alt="">
      <h5>3° Passo</h5>
    ...
    <div id="cadastrarJuiz">
      <h4>Cadastrar Juiz</h4>
      <hr>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/usuarios_cadastrar_juiz.png'); ?>"  alt="">
      <hr>
      <img class="img-fluid" src="<?php echo base_url('assets/imagens/tutorial/usuarios_cadastrar_juiz2.png'); ?>"  alt="">
    </div>
...
<script>
  $(document).ready(function(){
    ...
    $("a#equipesTurma").click(function(){
      hideAll();
      $("div#equipesTurma").show(1000);
      //console.log('clicou')
    });
    ...
    $("a#adicionarIntegrantes").click(function(){
      hideAll();
      $("div#adicionarIntegrantes").show(500);
    });

    $("a#cadastrarJogo").click(function(){
      hideAll();
      $("div#cadastrarJogo").show(500);
    });
    $("a#listarJogos").click(function(){
      hideAll();
      $("div#listarJogos").show(500);
    });
    $("a#editarJogo").click(function(){
      hideAll();
      $("div#editarJogo").show(500);
    });
    $("a#sumulaJogo").click(function(){
      hideAll();
      $("div#sumulaJogo").show(500);
    });
   
    $("a#listarPontos").click(function(){
      hideAll();
      $("div#listarPontos").show(500)
    })
    $("a#cadastrarUsuario").click(function(){
      hideAll();
      $('div#cadastrarUsuario').show(500)
    })
    $("a#editarUsuario").click(function(){
      hideAll();
      $('div#editarUsuario').show(500)
    })

    $("a#cadastrarModalidade").click(function(){
      hideAll();
      $('div#cadastrarModalidade').show(500)
    })
    $("a#editarModalidade").click(function(){
      hideAll();
      $('div#editarModalidade').show(500)
    })

    $("a#cadastrarLocal").click(function(){
      hideAll();
      $('div#cadastrarLocal').show(500)
    })
    $("a#editarLocal").click(function(){
      hideAll();
      $('div#editarLocal').show(500)
    })

    $("a#juizJogo").click(function(){
      hideAll()
      $('div#juizJogo').show(500)
    })
    $("a#cadastrarJuiz").click(function(){
      hideAll()
      $('div#cadastrarJuiz').show(500)
    })
